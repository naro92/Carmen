...
<html>
	<head>
		...
		<script>
			...
			Ajax().get('chat-getlist.php?patientID=<?php echo $patientID; ?>',putinfo);
			}	
	...
	<body>
		...
		<h1 style="position:absolute;top: 13%;left:23%"><?php echo "$getpatientnom";?></h1>
		<!-- 聊天框 Chat Box-->
