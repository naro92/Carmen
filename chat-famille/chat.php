...
<html>
	...
	<body>
		...
		<h1 style="position:absolute;top: 12%;left:23%"><?php echo "$getmedecinnom" . "&" . "$getpatientnom";?></h1>
		<!-- 聊天框 Chat Box-->
    ...
    background-color: #C9E265;color: #FFF;border: none; padding: 10px;border-radius: 3px;position: absolute;bottom: 12.3%;left: 70%;
